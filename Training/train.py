...
from Utils.pre_trained_utils import get_text_representation, get_tokenizer_and_model, get_image_model_processor
...
if __name__ == '__main__':
    ...
    mp.set_start_method('spawn', force=True)  # Use 'spawn' method for starting processes
